# API Endpoints Catalog - Runtime Snapshot
...
## Regras GODMOD aplicadas nesta documentacao

- Snapshot obtido por leitura/runtime, sem mutacao de dados.
- Inventario centralizado em um unico artefato em `docs/`.
- Uso de nomenclatura audivel para homologacao.
