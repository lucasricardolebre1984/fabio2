...
### Atualizacao 2026-02-20 (BUG-126 - rodada 2 e 3)
- backend/COFRE (blindagem/rollback):
...
- frontend:
  - `frontend/src/app/viva/page.tsx`
- ajustes adicionais:
  - full-width real na area de mensagens/input;
  - composer mais baixo (44..120);
  - container full-bleed para eliminar espaco morto inferior causado por padding do shell.
- evidencias:
